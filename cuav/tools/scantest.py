...
if __name__ == '__main__':
    ...
    parser.add_argument("--max-region-size", default=3.0, type=float, help="maximum region size (m)")
    parser.add_argument("--region-merge", default=3.0, type=float, help="region merge size (m)")
    parser.add_argument("--max-rarity-pct", default=0.02, type=float, help="maximum percentage rarity (percent)")
    parser.add_argument("--meters-per-pixel", default=0.2, type=float, help="meters per pixel on ground")
