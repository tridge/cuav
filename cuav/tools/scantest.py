...
parser.add_option("--fullres", action='store_true', default=True, help="show full resolution")
...
parser.add_option("--min-region-area", default=0.05, type='float', help="minimum region area (m^2)")
parser.add_option("--max-region-area", default=4.0, type='float', help="maximum region area (m^2)")
parser.add_option("--min-region-size", default=0.02, type='float', help="minimum region size (m)")
parser.add_option("--max-region-size", default=3.0, type='float', help="maximum region size (m)")
