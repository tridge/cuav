...
mavproxy.py --master=udpin:172.27.131.215:14650 --mav20 --console --map --load-module=cuav.modules.camera_ground --cmd="set moddebug 3; camera set air_address 172.27.72.161:14680:14670:60000; camera set camparms $PWD/../../../cuav/data/PiCamV2/params.json; camera view;"
